<template>
  <div class="mx-auto min-h-[calc(100vh-3.5rem)] max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
    <div class="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_18px_45px_rgba(15,23,42,0.06)] sm:p-8">
      ...
      <h1 class="mt-3 text-[34px] font-black tracking-tight text-slate-950 sm:text-[42px]"><Canvas>Matrix Ecommerce</Canvas> updates</h1>
...
const posts = [
  ...
  },
  {
    ...
    summary: 'Reach the support team by email for repeat orders, shipping questions, and B2B support.',
  },
];
</script>
